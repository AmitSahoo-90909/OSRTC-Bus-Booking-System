...
<%@include file="./navs.jsp" %>
	<div class="bbs_kha" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Baramunda BS | 05:37 AM</option>
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Khalikote | 06:25 AM</option>
			        <option>Khalikote | 05:54 PM</option>
			        <option>Khalikote | 09:06 PM</option>
      			</select>
  			</span>
