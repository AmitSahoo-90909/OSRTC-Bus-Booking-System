...
<%@include file="./navs.jsp" %>
	<div class="bbs_phul"  style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Baramunda BS | 04:52 PM</option>
    				<option>Baramunda BS | 09:45 PM</option>	   
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Phulbani | 09:55 PM</option>
			        <option>Phulbani | 02:07 PM</option>
      			</select>
  			</span>
