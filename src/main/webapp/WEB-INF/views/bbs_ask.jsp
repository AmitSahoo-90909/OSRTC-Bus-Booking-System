...
<%@include file="./navs.jsp" %>
	<div class="bbs_ask" style="background-color: background: #DAD299;
						...
						<div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										...
										<b>04h 30m</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 93px;">
										<b>Aska</b></li>
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Baramunda BS | 05:47 AM</option>
    				<option>Baramunda BS | 03:00 PM</option>
    				<option>Baramunda BS | 05:48 PM</option>
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Aska Bus Stand | 10:17 AM</option>
			        <option>Aska Bus Stand | 07:29 PM</option>
			        <option>Aska Bus Stand | 09:42 PM</option>
      			</select>
  			</span>
