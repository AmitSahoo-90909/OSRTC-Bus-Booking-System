...
<body>
		...
		<div class="destination_booking" style="background-color: background: #DAD299;
			background: -webkit-linear-gradient(to right, #B0DAB9, #DAD299);  
			background: linear-gradient(to right, #B0DAB9, #DAD299); height: 2300px;">
						...
						<img alt="icon" src="./resource/images/icon-assured.png" style="margin-top : 20px;">
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										...
										<b>OSRTC</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 25px; color: #072c6b; margin-left: 130px;">
										<b>11:15</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 25px; color: #072c6b; margin-left: 130px;">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 25px;">
										<b>DELUXE AC</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 77px;">
										<b>Bhubaneswar</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 82px;">
										<b>1h 15m</b></li>
										...
										<b>Puri</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 125px;">
										<b>ST-41</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 112px;">
										<b>99/-</b></li>
									</ul>
							...
							<div class="container">
								<div class="col-md-12 text-white text-center" style="height: 30px; width : 300px; border: 2px medium black; margin-top: 30px; margin-left: 20px; background: #072c6b; ">
									<b>VIA - RASULGARH, KALPANA</b>
									
									<div class="btnsubmit" style="margin-left: 850px;">
										<button class="btn btn-outline-success" type="submit" data-toggle="modal" data-target="#exampleFirstModalCenter"><b>VIEW AVAILABLE SEAT</b></button>
									</div>
								</div>
							</div>
					  </div>
					...
					<div class="col-md-12">
					  <div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
						<img alt="icon" src="./resource/images/icon-assured.png" style="margin-top : 20px;">
							...
							<div class="container">
								<div class="col-md-12 text-white text-center" style="height: 30px; width : 300px; border: 2px medium black; margin-top: 30px; margin-left: 20px; background: #072c6b; ">
									<b>VIA - KALPANA,PIPILI,SAKHIGOPAL</b>
						...
						<img alt="icon" src="./resource/images/icon-assured.png" style="margin-top : 20px;">
							...
							<div class="container">
								<div class="col-md-12 text-white text-center" style="height: 30px; width : 300px; border: 2px medium black; margin-top: 30px; margin-left: 20px; background: #072c6b; ">
									...
									<div class="btnsubmit" style="margin-left: 850px;">
										<button class="btn btn-outline-success" type="submit" data-toggle="modal" data-target="#exampleFirstModalCenter"><b>VIEW AVAILABLE SEATS</b></button>
									</div>
								</div>	
							</div>
					  </div>
      ...
      <p style="margin-left: 170px;padding: 20px;">
    	 	...
    	 	<!-- 1st modal -->
    	 	<!-- Modal -->
<div class="modal fade" id="exampleFirstModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        											...
        											<table style="width :100%; border : 0; align : left; cellpadding : 1; cellspacing : 1">
        												<tbody>
        													<tr>
        														<td nowrap="nowrap">
        															<div align="center">
        																<a title="99" href="#" class="link" data-number="38">
        											...
        											<table style="width :100%; border : 0; align : left; cellpadding : 1; cellspacing : 1">
        												<tbody>
        													<tr>
        														<td nowrap="nowrap">
        															<div align="center">
        																<a title="99" href="#" class="link" data-number="36">
        																	<img alt="seat" src="./resource/images/available_seat_icon.gif" 
        											...
        											<table style="width :100%; border : 0; align : left; cellpadding : 1; cellspacing : 1">
        												<tbody>
        													<tr>
        														<td nowrap="nowrap">
        															<div align="center">
        																<a title="99" href="#" class="link" data-number="32">
        																	<img alt="seat" src="./resource/images/available_seat_icon.gif" 
        											...
        											<table style="width :100%; border : 0; align : left; cellpadding : 1; cellspacing : 1">
        												<tbody>
        													<tr>
        														<td nowrap="nowrap">
        															<div align="center">
        																<a title="99" href="#" class="link" data-number="28">
        																	<img alt="seat" src="./resource/images/available_seat_icon.gif" 
        											...
        											<table style="width :100%; border : 0; align : left; cellpadding : 1; cellspacing : 1">
        												<tbody>
        													<tr>
        														<td nowrap="nowrap">
        															<div align="center">
        																<a title="99" href="#" class="link" data-number="24">
        																	<img alt="seat" src="./resource/images/available_seat_icon.gif" 
        											...
        											<table style="width :100%; border : 0; align : left; cellpadding : 1; cellspacing : 1">
        												<tbody>
        													<tr>
        														<td nowrap="nowrap">
        															<div align="center">
        																<a title="99" href="#" class="link" data-number="20">
        																	<img alt="seat" src="./resource/images/available_seat_icon.gif"
        											...
        											<table style="width :100%; border : 0; align : left; cellpadding : 1; cellspacing : 1">
        												<tbody>
        													<tr>
        														<td nowrap="nowrap">
        															<div align="center">
        																<a title="99" href="#" class="link" data-number="16">
        																	<img alt="seat" src="./resource/images/available_seat_icon.gif"
        											...
        											<table style="width :100%; border : 0; align : left; cellpadding : 1; cellspacing : 1">
        												<tbody>
        													<tr>
        														<td nowrap="nowrap">
        															<div align="center">
        																<a title="99" href="#" class="link" data-number="12">
        																	<img alt="seat" src="./resource/images/available_seat_icon.gif" 
        											...
        											<table style="width :100%; border : 0; align : left; cellpadding : 1; cellspacing : 1">
        												<tbody>
        													<tr>
        														<td nowrap="nowrap">
        															<div align="center">
        																<a title="99" href="#" class="link" data-number="8">
        																	<img alt="seat" src="./resource/images/available_seat_icon.gif"
        											...
        											<table style="width :100%; border : 0; align : left; cellpadding : 1; cellspacing : 1">
        												<tbody>
        													<tr>
        														<td nowrap="nowrap">
        															<div align="center">
        																<a title="99" href="#" class="link" data-number="4">
        																	<img alt="seat" src="./resource/images/available_seat_icon.gif" 
													...
													<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="37">
											...
											<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="35">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="31">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="27">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="23">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="19">
												...
												<table width="100%" border="0" cellpadding="1" cellspacing="0">
											         <tbody>
											             <tr>
											                <td nowrap="nowrap">
										                      <div align="center">
										                         <a title="99" href="#" class="link" data-number="15">
												...
												<table width="100%" border="0" cellpadding="1" cellspacing="0">
											         <tbody>
											             <tr>
											                <td nowrap="nowrap">
										                      <div align="center">
										                         <a title="99" href="#" class="link" data-number="11">
												...
												<table width="100%" border="0" cellpadding="1" cellspacing="0">
											         <tbody>
											             <tr>
											                <td nowrap="nowrap">
										                      <div align="center">
										                         <a title="99" href="#" class="link" data-number="7">
												...
												<table width="100%" border="0" cellpadding="1" cellspacing="0">
											         <tbody>
											             <tr>
											                <td nowrap="nowrap">
										                      <div align="center">
										                         <a title="99" href="#" class="link" data-number="3">
        										...
        										<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="39">
        										...
        										<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="40">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="34">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="30">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="26">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="22">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="18">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="14">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="10">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="6">
                                     		...
                                     		<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="2">
        									...
        									<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="41">
        									...
        									<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="33">
        									...
        									<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="29">
        									...
        									<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="25">
        									...
        									<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="21">
        									...
        									<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="17">
        									...
        									<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="13">
        									...
        									<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="9">
        									...
        									<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="5">
        									...
        									<td width="50" align="center">
											            ...
											            <tbody>
											                <tr>
											                    <td nowrap="nowrap">
										                        <div align="center">
										                            <a title="99" href="#" class="link" data-number="1">
      ...
      <form action="sent_booking_data" method="post">
      		...
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
			        ...
			        <option>Rasulgarh | 11:15</option>	
			        <option>Kalpana Sqr | 11:30</option>
			        <option>Palasuni | 11:28</option>
			        <option>Rasulgarh | 11:30</option>	
			        <option>Kalpana Sqr | 11:35</option>
			        <option>Palasuni | 18:08</option>
			        <option>Rasulgarh | 18:10</option>
			        <option>Kalpana Sqr | 18:15</option>
			        <option>Palasuni | 18:25</option>	
			        <option>Rasulgarh | 18:30</option>	
			        <option>Kalpana Sqr | 18:40</option>	
			        <option>Rasulgarh | 19:30</option>	
			        <option>Kalpana Sqr | 19:40</option>	
			        <option>Rasulgarh | 12:10</option>	
			        <option>Kalpana Sqr | 12:20</option>		   
      			</select>
  			</span> 
  			
  			<span class="pickup" style="margin-left: 75px;">
  				<label for="pick"><h5 style="color: #072c6b">Dropup Points</h5></label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    			<select id="inputState" name="dropups">
			        <option>-SELECT-</option>	
			        <option>Puri | 12:30</option>	
			        <option>Puri | 12:45</option>	
			        <option>Puri | 19:25</option>
			        <option>Puri | 20:00</option>
			        <option>Puri | 20:50</option>	
			        <option>Puri | 13:40</option>		   
      			</select>
  			</span> <br>
