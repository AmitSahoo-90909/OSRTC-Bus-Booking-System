...
<%@include file="./nav.jsp" %>
		<div class="register" style="background: #E0EAFC;
				background: -webkit-linear-gradient(to right, #CFDEF3, #E0EAFC);  
				background: linear-gradient(to right, #CFDEF3, #E0EAFC);">
			<h2 style="color: #072c6b; padding-top: 130px; text-align: center;">Register</h2>
			<br>
				<h3 class="text-center text-danger">${name}</h3>
			<br>
			<div class="container" style="height: 430px; margin-top: 40px;">
				<div class="container" style="border: 2px solid gray; height: 390px; width : 700px; padding-top: 20px;">
					<form action="officeregister" method="post">
					
						<div class="form-group">
						    <label for="formGroupExampleInput"><b>Name</b></label>
						    <input type="text" name="names" class="form-control" id="formGroupExampleInput" placeholder="Enter Name">
  						</div>
