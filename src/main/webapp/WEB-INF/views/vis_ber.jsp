...
<%@include file="./navs.jsp" %>
	<div class="vis_ber" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				<option selected>Visakhapatnam | 08:08 PM</option>
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
			        <option selected>Berhampur New BS | 03:07 AM</option>
      			</select>
  			</span>
