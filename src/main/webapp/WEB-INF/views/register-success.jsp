...
<%@include file="./navs.jsp" %>
		<div class="register_Success" style="background-color: #e7eaeb!important; height: 700px;">
			<br>
				<div class="container" style="margin-top: 50px;">
					<div class="card" style="margin-top: 250px;">
					  ...
					  <div class="card-body">
					    <h4 class="card-title text-success">Successfully Registered To OSRTC</h4>
					    <p class="card-text">Now Login With Your Mobile Number By Clicking The Button.</p>
					    <a href="logs" class="btn btn-outline-primary btn-lg"><b class="text-uppercase">Login</b></a>
					  </div>
					</div>
				</div>
		</div>
