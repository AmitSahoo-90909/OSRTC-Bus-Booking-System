...
<%@include file="./navs.jsp" %>
	<div class="bbs_keo" style="background-color: background: #DAD299;
				background: -webkit-linear-gradient(to right, #B0DAB9, #DAD299);  
				background: linear-gradient(to right, #B0DAB9, #DAD299); height: 1670px;">
			<br>
			...
			<div class="bus_details">
					<div class="col-md-12">
						<div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 30px;">
										<b>HICOMF</b></li>
										...
										<b>Keonjhar</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 98px;">
										<b>ST-41</b></li>
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Baramunda BS | 06:30 AM</option>
    				<option>Baramunda BS | 07:15 AM</option>
    				<option>Baramunda BS | 01:40 PM</option>	   
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
			        <option>-SELECT-</option>
			        <option>Keonjhar Bus Stop | 12:30 PM</option>	
			        <option>Keonjhar Bus Stop | 12:50 PM</option> 
			        <option>Keonjhar Bus Stop | 03:45 PM</option>
			        <option>Keonjhar Bus Stop | 07:25 PM</option>
      			</select>
  			</span>
