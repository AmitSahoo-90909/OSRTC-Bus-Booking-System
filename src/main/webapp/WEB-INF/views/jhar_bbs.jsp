...
<%@include file="./navs.jsp" %>
		<div class="jhar_bbs" style="background-color: background: #DAD299;
						...
						<div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										...
										<b>Jharsuguda</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 86px;">
										<b>10h 00m</b></li>
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Jharsuguda | 07:30 PM</option>
			        <option>Jharsuguda | 08:30 PM</option>		
			        <option>Jharsuguda | 09:25 PM</option>	   
      			</select>
  			</span> 
