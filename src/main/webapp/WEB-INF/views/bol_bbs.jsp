...
<%@include file="./navs.jsp" %>
	<div class="bol_bbs" style="background-color: background: #DAD299;
						...
						<div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										...
										<b>Bolangir</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 102px;">
										<b>06h 35m</b></li>
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Bolangir Bus Stop | 01:13 AM</option>
			        <option>Bolangir Bus Stop | 06:00 PM</option>
			        <option>Bolangir Bus Stop | 08:00 PM</option>
			        <option>Bolangir Bus Stop | 08:30 PM</option>
			        <option>Bolangir Bus Stop | 09:30 PM</option>	   
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Baramunda BS | 07:48 PM</option>
    				<option>Baramunda BS | 04:30 AM</option>
    				<option>Baramunda BS | 06:00 AM</option>
    				<option>Baramunda BS | 05:30 AM</option>
    				<option>Baramunda BS | 06:34 AM</option>
      			</select>
  			</span>
