...
<%@include file="./navs.jsp" %>
		<div class="bbs_nua" style="background-color: background: #DAD299;
						...
						<div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										...
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 37px;">
										<b>Bhubaneswar</b></li>
										...
										<b>12h 46m</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 85px;">
										<b>Nuapada</b></li>
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
			        ...
			        <option>Baramunda BS | 07:08 PM</option>	
			        <option>Baramunda BS | 08:43 PM</option>	   
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Nuapada Bus Stop | 07:54 AM</option>
			        <option>Nuapada Bus Stop | 07:10 AM</option>		   
      			</select>
  			</span> 
