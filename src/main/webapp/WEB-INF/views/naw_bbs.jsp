...
<%@include file="./navs.jsp" %>
		<div class="naw_bbs" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Nawarangpur | 04:00 PM</option>
			        <option>Nawarangpur | 05:55 PM</option>		
			        <option>Nawarangpur | 08:19 PM</option>    
      			</select>
  			</span> 
