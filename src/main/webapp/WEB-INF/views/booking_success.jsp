...
<body>
	...
	<div class="pnr" style="background-color: #e7eaeb!important; height: 700px;">
		<br>
		<br>
		<div class="container" style="margin-top: 70px;padding-top : 20px; height: 560px;">
			<div class="alert alert-success" role="alert" style="margin-top: 175px;">
			  <h4 class="alert-heading"><h2>Thank You! For Using OSRTC</h2></h4>
			  <p><b>Ticket Booked Successfully. Pnr no. for this ticket is generated. Please , keep the pnr no. for future reference.</b></p>
			  <hr>
			  <p class="mb-0"><b>PNR Number :- ${pnr}</b>, Use this Pnr number to Download/Print/Cancel Ticket. </p>
			</div>
		</div>
	</div>
	<footer class="foot">
