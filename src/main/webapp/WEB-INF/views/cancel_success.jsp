...
<body>
	...
	<div class="cancel_success" style="background-color: #e7eaeb!important; height: 650px;">
		<div class="container" style="margin-top: 70px;padding-top : 20px; height: 560px;">
			<div class="alert alert-info" role="alert" style="margin-top: 175px;">
			  <h4 class="alert-heading"><h2>Thank You! For Using OSRTC</h2></h4>
			  <p><b>Ticket Cancelled Successfully.</b></p>
			  <hr>
			  <p class="mb-0"><b>PNR Number :- ${pnr}</b> & 
			  <b>Refundable amount will be reflected in your bank a/c within 48 hours. Now close the window or go to home page for other bookings.</b></p>
			</div>
		</div>
	</div>
	<footer class="foot">
