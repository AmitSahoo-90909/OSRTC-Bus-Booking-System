...
<%@include file="./navs.jsp" %>
	<div class="bbs_ber" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Baramunda BS | 07:09 AM</option>
    				<option>Baramunda BS | 07:45 AM</option>
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Berhampur New BS | 10:30 AM</option>
			        <option>Berhampur New BS | 10:30 AM</option>
			        <option>Berhampur New BS | 11:00 AM</option>
			        <option>Berhampur New BS | 06:09 PM</option>
			        <option>Berhampur New BS | 07:00 PM</option>
			        <option>Berhampur New BS | 08:45 PM</option>
      			</select>
  			</span>
