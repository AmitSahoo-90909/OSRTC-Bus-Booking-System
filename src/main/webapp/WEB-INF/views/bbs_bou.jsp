...
<%@include file="./navs.jsp" %>
	<div class="bbs_bou" style="background-color: background: #DAD299;
						...
						<div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										...
										<b>DELUX AC</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 92px;">
										<b>Bhubaneswar</b></li>
										...
										<b>Boudh</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 111px;">
										<b>ST-41</b></li>
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Baramunda BS | 03:30 PM</option>
    				<option>Baramunda BS | 04:30 PM</option>
    				<option>Baramunda BS | 05:00 PM</option>
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Boudh | 12:54 PM</option>
			        <option>Boudh | 01:00 AM</option>
			        <option>Boudh | 10:00 PM</option>
			        <option>Boudh | 12:05 AM</option>
			        <option>Boudh | 01:55 AM</option>
      			</select>
  			</span>
