...
<%@include file="./navs.jsp" %>
	<div class="bbs_dhe" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Baramunda BS | 09:38 PM</option>	     			   
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
			        <option>-SELECT-</option>
			        <option>Dhenkanal | 10:20 AM</option>	
			        <option>Dhenkanal | 12:32 AM</option>   
      			</select>
  			</span>
