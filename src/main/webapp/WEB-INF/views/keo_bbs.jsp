...
<%@include file="./navs.jsp" %>
	<div class="keo_bbs" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Keonjhar Bus Stop | 05:00 AM</option>	
			        <option>Keonjhar Bus Stop | 05:15 AM</option> 
			        <option>Keonjhar Bus Stop | 09:40 AM</option>
			        <option>Keonjhar Bus Stop | 05:12 PM</option>					   
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
			        <option>-SELECT-</option>
			        <option>Baramunda BS | 10:30 PM</option>
    				<option>Baramunda BS | 02:00 PM</option>
    				<option>Baramunda BS | 04:40 PM</option>
    				<option>Baramunda BS | 11:25 PM</option>
      			</select>
  			</span>
