...
<%@include file="./navs.jsp" %>
	<div class="dig_bbs" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Digapahandi | 01:49 AM</option>
			        <option>Digapahandi | 03:02 AM</option>
			        <option>Digapahandi | 07:11 AM</option>
			        <option>Digapahandi | 11:32 PM</option>
      			</select>
  			</span> 
