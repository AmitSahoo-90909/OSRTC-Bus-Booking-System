...
<%@include file="./navs.jsp" %>
		<div class="bbs_ray" style="background-color: background: #DAD299;
						...
						<div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										...
										<b>VOLVO</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 105px;">
										<b>Bhubaneswar</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 79px;">
										<b>10h 30m</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 83px;">
										<b>Rayagada</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 99px;">
										<b>ST-41</b></li>
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
			        ...
			        <option>Baramunda BS | 03:59 PM</option>	
			        <option>Baramunda BS | 05:15 PM</option>
			        <option>Baramunda BS | 06:05 PM</option>
			        <option>Baramunda BS | 07:19 PM</option>
			        <option>Baramunda BS | 07:30 PM</option>
			        <option>Baramunda BS | 08:00 PM</option>
			        <option>Baramunda BS | 09:30 PM</option>	   
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Rayagada | 02:29 AM</option>
			        <option>Rayagada | 02:00 AM</option>		
			        <option>Rayagada | 02:48 AM</option>   
			        <option>Rayagada | 02:48 AM</option>
			        <option>Rayagada | 07:00 AM</option>
			        <option>Rayagada | 03:00 AM</option>
			        <option>Rayagada | 05:15 AM</option>
      			</select>
  			</span> 
