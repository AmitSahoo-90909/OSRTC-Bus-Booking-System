...
<%@include file="./navs.jsp" %>
			<div class="kor_bbs" style="background-color: background: #DAD299;
						...
						<div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										...
										<b>Koraput</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 103px;">
										<b>13h 34m</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 73px;">
										<b>Bhubaneswar</b></li>
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Koraput | 03:38 PM</option>
			        <option>Koraput | 05:24 PM</option>
			        <option>Koraput | 05:40 PM</option>	
			        <option>Koraput | 07:00 PM</option>
			        <option>Koraput | 07:08 PM</option>
			        <option>Koraput | 07:20 PM</option>		   
      			</select>
  			</span> 
