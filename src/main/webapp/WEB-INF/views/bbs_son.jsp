...
<%@include file="./navs.jsp" %>
	<div class="bbs_son" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Sonepur | 02:17 PM</option>
			        <option>Sonepur | 02:00 AM</option>
			        <option>Sonepur | 11:15 PM</option>
			        <option>Sonepur | 02:15 AM</option>
			        <option>Sonepur | 01:26 AM</option>
      			</select>
  			</span>
