...
<%@include file="./navs.jsp" %>
	<div class="bbs_parla" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
    				...
    				<option>Baramunda BS | 09:00 PM</option>
    				<option>Baramunda BS | 09:20 PM</option>	   
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Parlakhemundi | 04:30 AM</option>
			        <option>Parlakhemundi | 05:00 AM</option>
      			</select>
  			</span>
