...
<%@include file="./navs.jsp" %>
			<div class="puri_bbs" style="background-color: background: #DAD299;
			...
			<div class="bus_details">
					<div class="col-md-12">
						<div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 23px;">
										<b>AC DELUXE</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 114px;">
										<b>Puri</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 118px;">
										<b>1h 25m</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 80px;">
										<b>Bhubaneswar</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 80px;">
										<b>ST-41</b></li>
						...
						<div class="container" style="margin-top: 20px; border: 2px solid black; height: 300px; background: #f2f2f2">
							...
							<div class="col-md-12">
									<ul class="nav navbar navbar-left d-flex d-inline-flex">
										...
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 114px;">
										<b>Puri</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 122px;">
										<b>1h 5m</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 87px;">
										<b>Bhubaneswar</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 80px;">
										<b>ST-41</b></li>
										<li class="nav-item d-inline-flex  align-items-center mr-2" style="list-style-type: none; margin-top: 5px; color: #072c6b; margin-left: 112px;">
      ...
      <form action="sent_booking_data" method="post">
      		...
      		<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="pickups">
					        ...
					        <option>Puri | 14:10</option>	
					        <option>Puri | 06:45</option>	
					        <option>Puri | 14:20</option>
					        <option>Puri | 07:10</option>
					        <option>Puri | 15:15</option>	
					        <option>Puri | 08:10</option>
      			</select>
  			</span> 
  			...
  			<span class="pickup" style="margin-left: 75px;">
    			...
    			<select id="inputState" name="dropups">
			        	<option>-SELECT-</option>
			        	<option>Rasulgarh | 15:25</option>	
			        	<option>Kalpana Sqr | 15:35</option> 
			        	<option>Kalpana Sqr | 07:50</option>
						<option>Rasulgarh | 08:00</option>
						<option>Kalpana Sqr | 15:30</option>
						<option>Rasulgarh | 15:35</option>
						<option>Kalpana Sqr | 08:15</option>
						<option>Rasulgarh | 08:20</option>
						<option>Palasuni | 08:25</option>
						<option>Kalpana Sqr | 16:30</option>
						<option>Rasulgarh | 16:40</option>
						<option>Kalpana Sqr | 09:25</option>
						<option>Rasulgarh | 09:30</option>
      			</select>
  			</span> <br>
