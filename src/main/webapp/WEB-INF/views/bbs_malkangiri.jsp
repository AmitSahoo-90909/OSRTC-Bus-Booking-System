...
<%@include file="./navs.jsp" %>
		<div class="bbs-mal" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Malkangiri Bus Stop | 04:40 AM</option>
			        <option>Malkangiri Bus Stop | 07:30 AM</option>
			        <option>Malkangiri Bus Stop | 07:50 AM</option>			   
      			</select>
  			</span> 
