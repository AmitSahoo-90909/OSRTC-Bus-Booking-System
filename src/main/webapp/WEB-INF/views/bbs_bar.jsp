...
<%@include file="./navs.jsp" %>
		<div class="bbs_bar" style="background-color: background: #DAD299;
      ...
      <form action="sent_booking_data" method="post">
  			...
  			<span class="pickup" style="margin-left: 30px;">
    			...
    			<select id="inputState" name="dropups">
    				<option>-SELECT-</option>
			        <option>Bargarh Bus Stop | 07:21 PM</option>
			        <option>Bargarh Bus Stop | 05:00 AM</option>
			        <option>Bargarh Bus Stop | 06:27 AM</option>  
      			</select>
  			</span> 
